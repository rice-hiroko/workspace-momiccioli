...
cprequire_test(["inline:com-chilipeppr-workspace-momiccioli"], function(ws) {
    ...
    $('title').html("momiccioli Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-momiccioli", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-momiccioli", // Make the id the same as the cpdefine id
        name: "Workspace / momiccioli", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace forked by momiccioli to work on other widgets.`,
